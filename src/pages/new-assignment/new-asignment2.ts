...
import { InAppBrowser, InAppBrowserEvent, InAppBrowserRef} from '@ionic-native/in-app-browser';

declare var gapi: any;

interface BrowserEvent extends InAppBrowserEvent{ } 
interface BrowserRef extends InAppBrowserRef{ addEventListener(type: string, callback: (event: InAppBrowserEvent) => void): any; }
